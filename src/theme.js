...
function getTheme({ style, name }) {
  ...
  return {
    ...
    colors: {
      ...
      "activityBar.background": pick({ pink: primer.pink[1], light: primer.white, dark: primer.gray[0] }),
      ...
      "sideBar.background": pick({ pink: primer.pink[0], light: primer.gray[1], dark: "#1f2428" }),
      ...
      "sideBarSectionHeader.background": pick({ pink: primer.gray[2], light: primer.gray[1], dark: "#1f2428" }),
      ...
      "statusBar.background": pick({ pink: primer.pink[0], light: primer.white, dark: primer.gray[0] }),
      ...
      "editorGroupHeader.tabsBackground": pick({ pink: primer.pink[0], light: primer.gray[1], dark: "#1f2428" }),
      ...
      "tab.inactiveBackground": pick({ pink: primer.gray[1], light: primer.gray[1], dark: "#1f2428" }),
      "tab.activeBackground": pick({ pink: primer.white, light: primer.white, dark: primer.gray[0] }),
      "tab.hoverBackground": pick({ pink: primer.white, light: primer.white, dark: primer.gray[0] }),
      "tab.unfocusedHoverBackground": pick({ pink: primer.white, light: primer.white, dark: primer.gray[0] }),
      "tab.border": pick({ pink: primer.gray[2], light: primer.gray[2], dark: primer.white }),
      "tab.unfocusedActiveBorderTop": pick({ pink: primer.gray[2], light: primer.gray[2], dark: primer.white }),
      "tab.activeBorder": pick({ pink: primer.white, light: primer.white, dark: primer.gray[0] }),
      "tab.unfocusedActiveBorder": pick({ pink: primer.white, light: primer.white, dark: primer.gray[0] }),
      ...
      "terminal.foreground": pick({ pink: "#000000" }),
      "terminal.background": pick({ pink: "#deb1e0" }),
      "terminal.ansiBlack": pick({ pink: "#000000" }),
      "terminal.ansiBlue": pick({ pink: "#005cc5" }),
      "terminal.ansiBrightBlack": pick({ pink: "#586069" }),
      "terminal.ansiBrightBlue": pick({ pink: "#79b8ff" }),
      "terminal.ansiBrightCyan": pick({ pink: "#b392f0" }),
      "terminal.ansiBrightGreen": pick({ pink: "#85e89d" }),
      "terminal.ansiBrightMagenta": pick({ pink: "#deb1e0" }),
      "terminal.ansiBrightRed": pick({ pink: "#f97583" }),
      "terminal.ansiBrightWhite": pick({ pink: "#feffff" }),
      "terminal.ansiBrightYellow": pick({ pink: "#f7ff0b" }),
      "terminal.ansiCyan": pick({ pink: "#5a32a3" }),
      "terminal.ansiGreen": pick({ pink: "#22863a" }),
      "terminal.ansiMagenta": pick({ pink: "#ad8aaf" }),
      "terminal.ansiRed": pick({ pink: "#cb2431" }),
      "terminal.ansiWhite": pick({ pink: "#d1d5da" }),
      "terminal.ansiYellow": pick({ pink: "#f9c513" }),
